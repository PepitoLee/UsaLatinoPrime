...
import { CredibleFearRow } from '@/components/admin/CredibleFearRow'

export default async function MiedoCreiblePage() {
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            ...
            Formularios de Miedo Cre&iacute;ble
          </h1>
      ...
      <div>
        ...
        {pending.length > 0 ? (
          <div className="space-y-3">
            {pending.map((sub: any) => (
              <CredibleFearRow key={sub.id} submission={sub} />
            ))}
          </div>
        ) : (
          <Card>
